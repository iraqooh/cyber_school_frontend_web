      ...
      <div class="d-flex justify-content-center w-50-md w-100">
        ...
        <div class="d-flex justify-content-center w-50-md w-100" v-if="showStudentDetails">
            <div class="w-100">
                ...
                <p><strong>Fees:</strong> {{ newStudent.fees.toLocalString('en-US') }}</p>
                <p><strong>Initial Payment:</strong> {{ newStudent.initial_payment.toLocalString('en-US') }}</p>
...
<script>
    ...
    export default {
        ...
        methods: {
            addStudent() {
                ApiService.addStudent(this.form).then(response => {
                    console.log(response.data)
                    this.newStudent = response.data;
                    this.newStudent.fees = this.form.school_fees
                    this.newStudent.initial_payment = this.form.initial_payment
