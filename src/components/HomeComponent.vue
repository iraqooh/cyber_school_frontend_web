<template>
    <div>
      ...
      <div class="analytics-banner d-flex justify-content-around p-3 bg-light">
        <div class="card" v-for="(value, key) in analyticsDetails" :key="key">
            ...
            <div class="d-flex justify-content-center">
              <svg width="60" height="60">
                ...
                <circle cx="30" cy="30" r="25" :stroke="percentagePaidColor" 
                    stroke-width="5" fill="none" :stroke-dasharray="analytics.percentagePaid + ' 100'" 
                    stroke-dashoffset="25" transform="rotate(-90, 30, 30)"></circle>
      ...
      <div class="main-content d-flex">
        <div class="row w-100 mx-5">
          ...
          <div class="col-md-4 p-3" v-if="selectedStudent">
            <div class="d-flex justify-content-between align-items-center my-3">
              <h5 class="">Student Biodata</h5>
              <router-link class="btn btn-primary" :to="{ name: 'edit-student', params: {id: selectedStudent.student_id} }">Edit Student</router-link>
            </div>
  ...
  export default {
    ...
    computed: {
      ...
      analyticsDetails() {
        return {
          registeredStudentsCount: { title: 'Registered Students', text: this.analytics.registeredStudentsCount },
          totalExpectedFees: { title: 'Expected Fees', text: `UGX ${this.analytics.totalExpectedFees.toLocaleString('en-US')}` },
          totalPayments: { title: 'Current Payments', text: `UGX ${this.analytics.totalPayments.toLocaleString('en-US')}` },
          outstandingFees: { title: 'Outstanding Fees', text: `UGX ${this.analytics.outstandingFees.toLocaleString('en-US')}` }
        };
      }
    },
    methods: {
